...
# non-fastpath, VLAN configuration for Pica8 3290
...
ovs-vsctl add-port $BR ge-1/1/1 vlan_mode=trunk -- set Interface ge-1/1/1 type=pica8
ovs-vsctl add-port $BR ge-1/1/2 vlan_mode=trunk -- set Interface ge-1/1/2 type=pica8
